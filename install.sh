...
# --- Argo 隧道配置 ---
export ARGO_DOMAIN="xxxx.cckkvv.eu.org"           # Argo 域名，留空即启用临时隧道
export ARGO_AUTH="{"AccountTag":"e42e2b87ffd0662e3276b511806c9a61","TunnelSecret":"UroOJiQxI0Jp/GYuA2rhozP2W1ttpFJAq9jXRhyvK9Q=","TunnelID":"5ce3dec5-3d2c-45db-995c-102ffd5d668e","Endpoint":""}"             # Argo Token 或 json，留空即启用临时隧道
